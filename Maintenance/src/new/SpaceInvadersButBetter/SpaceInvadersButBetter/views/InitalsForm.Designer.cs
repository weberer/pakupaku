namespace SpaceInvadersButBetter.views
{
   partial class InitalsForm
   {
      ...
      private void InitializeComponent()
      {
         ...
         this.txtInitials.BorderStyle = System.Windows.Forms.BorderStyle.None;
         ...
         this.txtInitials.Location = new System.Drawing.Point(220, 196);
         this.txtInitials.MaxLength = 3;
         this.txtInitials.Name = "txtInitials";
         this.txtInitials.Size = new System.Drawing.Size(93, 42);
         this.txtInitials.TabIndex = 43;
         this.txtInitials.Text = "123";
         // 
         // label3
         // 
